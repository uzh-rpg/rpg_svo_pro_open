...
public:
   ...
   * @param T_old_new Transformation such that T_old_new*p_old = p_new
   */
  bool getTransformRansac(const int min_num_3d, const bool relax_thresh,
                          Transformation* T_old_new, std::vector<int>* inliers);
  ...
  /**
   * @brief Jointly optimize the epipolar and reprojection error to get relative
   * pose
   */
